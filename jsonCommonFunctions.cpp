...
namespace jsonFunctions
{
	...
	namespace vehicle
	{
		VehiclePhysicalModel::Inertial readInertialData( configFiles::fileID configID )
		{
			...
			data.centerOfGravity << centerOfGravity.get< jsonxx::Number >( 0 ),
			    centerOfGravity.get< jsonxx::Number >( 1 ), centerOfGravity.get< jsonxx::Number >( 2 );
		...
		VehiclePhysicalModel::Drag readDragData( configFiles::fileID configID )
		{
			...
			data.linear = VehiclePhysicalModel::Drag::Linear{
				static_cast< double >( linearData.get< jsonxx::Number >( "Xu" ) ),
	...
	namespace regulator
	{
		AllocationPenalizers readPenalizerData( configFiles::fileID configID )
		{
			...
			auto penData = desiredConfigFile->parsedFile.get< jsonxx::Object >( "regulator" )
			                   .get< jsonxx::Object >( "penalizers" );
